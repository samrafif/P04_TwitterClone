    ...
    <div class="wrapper-left">
        <div class="sidebar-left">
          <div class="grid-sidebar" style="margin-top: 12px">
            ...
            <i style="font-size: 32px; color:#fc5130" class="fas fa-paw"></i>
            </div>
          </div>
          ...
          <div class="grid-sidebar" style="margin-top: 12px">
            <div class="icon-sidebar-align">
            <i style="font-size: 26px; color:grey" class="fas fa-home"></i>
            </div>
          ...
          <div class="grid-sidebar">
            <div class="icon-sidebar-align position-relative">
              ...
              <?php } ?>
              <i style="font-size: 26px; color:grey" class="fas fa-bell"></i>
          ...
          <div class="grid-sidebar  bg-active">
            <div class="icon-sidebar-align">
            <i style="font-size: 26px; color:grey" class="fas fa-user"></i>
            </div>
  
            <div class="wrapper-left-elements">
              <!-- <a href="/twitter-clone-master/<?php echo $user->username; ?>"  style="margin-top: 4px"><strong>Profile</strong></a> -->
          ...
          <div class="grid-sidebar ">
            <div class="icon-sidebar-align">
            <i style="font-size: 26px; color:grey" class="fas fa-cog"></i>
            </div>
